 ...
 *
 * $Id: VertexCovers.java 1923 2007-11-13 14:17:48Z tla $
 *
 * Changes
 * -------
...
public class VertexCovers {
    ...
    public Set find2ApproximationCover( Graph g ) {
        // Comment changed by Jason Breck in 2014-04 to remove empty-set character
        // C <-- empty_set
    ...
    public Set findGreedyCover( UndirectedGraph g ) {
        // C <-- empty_set (Comment text changed by Jason Breck in 2014-4) 
        Set cover = new HashSet(  );
        ...
        // while G' != empty_set (Comment text changed by Jason Breck in 2014-04)
        while( sg.edgeSet(  ).size(  ) > 0 ) {
