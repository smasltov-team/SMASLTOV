package tvla.analysis.equationSystem;
...
import tvla.jeannet.equationSystem.Fixpoint;

/** This is a stub engine used by the ITVLA-(that is, equation system TVLA)-TVLA3 hybrid.
 * Currently, its main purpose is to be a holder for the AnalysisStatus instance that
 *  is used to keep track of timing information.
 * @author Jason Breck 
 */
public class EquationSystemEngine extends Engine {
...
OUTER: while (!workSet.isEmpty()) {
	...
	protected void printStatistics() {
		...
		*/
        ...
        // This next line is a temporary hack to help us figure out where the rest of the time
        //   is going in this sytem.
        Logger.println("Cleanup time               : " + 
                       String.format("%.4f", (System.nanoTime() - Fixpoint.instance.stepStartTime)/1000000000.0 )
                       + " seconds");
	}
