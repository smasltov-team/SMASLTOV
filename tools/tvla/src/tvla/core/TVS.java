...
public abstract class TVS {
	...
	///////////////////////////////////////////////////////////////////////////
        ...
        /** A constant denoting an empty structure;
         *  (Copied by Jason Breck from Jeannet's TVLA to match the interface expected therein.)
         */
        public static final HighLevelTVS EMPTY_TVS = tvla.core.common.EmptyTVS.instance;
