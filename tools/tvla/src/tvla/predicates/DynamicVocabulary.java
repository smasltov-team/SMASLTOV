...
public class DynamicVocabulary {
    ...
    protected static HashConsFactory<DynamicVocabulary, Set<Predicate>>.CommBinOp<DynamicVocabulary> union = factory.new CommBinOp<DynamicVocabulary>() {
        @Override
        protected DynamicVocabulary actualApply(DynamicVocabulary left, DynamicVocabulary right) {
    ...
    protected static HashConsFactory<DynamicVocabulary, Set<Predicate>>.BinOp<Boolean> subsetof = factory.new BinOp<Boolean>() {
        @Override
        protected Boolean actualApply(DynamicVocabulary left, DynamicVocabulary right) {
    ...
    public static DynamicVocabulary full() {
        if (full == null || full.predicates.size() != Vocabulary.allPredicates().size()) {
            full = DynamicVocabulary.create(HashSetFactory.make(Vocabulary.allPredicates()));
        }
        return full;
    }
